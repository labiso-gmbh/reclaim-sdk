...
class Webhook(BaseResource):
    ...
    status: Optional[str] = Field(None, description="Webhook status (ACTIVE/SUSPENDED/DISABLED/DOWNGRADED)")
    api_version: Optional[str] = Field(None, alias="apiVersion", description="Webhook API version")
    created_at: Optional[datetime] = Field(None, alias="createdAt", description="Webhook creation timestamp")
